...
import com.emotus.app.databinding.MoodEntriesBinding
...
class MoodsAdapter : ListAdapter<DataItem, MoodsAdapter.MyViewHolder>(DIFF_CALLBACK) {
    ...
    class MyViewHolder(
        ...
        fun bind(mood: DataItem) {
            ...
            binding.dateHistory.text =
                date.formatDatesTime(mood.createdAt)[1] + " | " + date.formatDatesTime(mood.createdAt)[2]
//            binding.dateHistory.text = mood.createdAt
